...
<div style="padding:12px;background:#fff;border-radius:6px;box-shadow:0 2px 14px -4px rgba(0,0,0,0.08);border:1px solid #f0f0f0;overflow:hidden;margin-bottom:12px">
    ...
    <div style="margin-left:92px;min-height:80px">
        ...
        <div style="system-ui;color:#666;padding:8px;background:#fafafa;border-radius:4px;border:1px solid #f5f5f5">我最爱的博主，盘中跟，对于他推荐的高位的尽量不追高，先研究研究再说，先看看有没有融资买入啊，历史走势喜不喜欢跳水啊，尽量等回调，但是低位推荐的可以快速查看一下然后直接追。他推荐的票有较长持续性，可以拿两天，除非你发现明显不对才需要提前走，而他也会说的，所以不着急，跟着他买的票不需要开盘就跑。</div>
    </div>
</div>
<div style="padding:12px;background:#fff;border-radius:6px;box-shadow:0 2px 14px -4px rgba(0,0,0,0.08);border:1px solid #f0f0f0;overflow:hidden;margin-bottom:12px">
    <div style="float:left;width:80px;margin-right:12px">
